    ...
    <div class="b--lang-a" data-dropdown-languages v-if="languages">
        ...
        <div class="b--lang-a__wrapper" data-options>
            <ul class="b--lang-a__wrapper__list-group" data-options>
                <li class="b--lang-a__wrapper__list-group__list-item" :class="{'b--lang-a__wrapper__list-group__list-item--is-active' : languageSelectorActive == languages.en}">
                    <a class="b--lang-a__wrapper__list-group__list-item__link" href="#" @click.prevent="changeLanguage('')">{{languages.en}}</a>
                </li>
                <li class="b--lang-a__wrapper__list-group__list-item" :class="{'b--lang-a__wrapper__list-group__list-item--is-active' : languageSelectorActive == languages.fr}">
                    <a class="b--lang-a__wrapper__list-group__list-item__link" href="#" @click.prevent="changeLanguage('fr')">{{languages.fr}}</a>
                </li>
                <li class="b--lang-a__wrapper__list-group__list-item" :class="{'b--lang-a__wrapper__list-group__list-item--is-active' : languageSelectorActive == languages.es}">
